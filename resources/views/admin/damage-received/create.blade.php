    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <!-- end page title -->
                <form class="custom-validation" action="{{ route('damage-received.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <div>
                                            <input data-parsley-type="text" type="number" class="form-control" required placeholder="Enter Recived Value" name="recived_value" step="0.01">
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4">
