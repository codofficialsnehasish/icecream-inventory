                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                            <a href="{{ route('customer.add') }}" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
                                            ...
                                            <thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-success mr-2" href="{{ route('customer.edit', $s->id) }}" alt="edit"><i class="ti-check-box"></i></a>
                                                            <a class="btn btn-danger" onclick="return confirm('Are you sure?')" href="{{ route('customer.delete', $s->id) }}"><i class="ti-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
