                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="mb-3 col-md-6">
                                                                        <div class="mb-2">
                                                                            <label class=" fs-6 fw-semibold mb-2">Customer
                                                                                Image</label>
                                                                            <img class="img-thumbnail rounded me-2"
                                                                                id="customer_image" alt="" width="200"
                                                                                src="{{ $customer->image }}" data-holder-rendered="true"
                                                                                style="">
                                                                        </div>
                                                                        <div class="form-group mt-2">
                                                                            ...
                                                                            <input type="file" class="form-control"
                                                                                name="image" id="customer_image_input" />
                                                                        </div>
