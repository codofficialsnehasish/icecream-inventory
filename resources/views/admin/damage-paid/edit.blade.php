    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <!-- end page title -->
                <form class="custom-validation" action="{{ route('damage-paid.update',$damage_paid->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="card-body row">
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <div class="input-group" id="datepicker2">
                                            <input type="text" class="form-control" placeholder="dd M, yyyy" name="date"
                                                ...
                                                data-date-autoclose="true" required autocomplete="off" value="{{ \Illuminate\Support\Carbon::parse($damage_paid->date)->format('d M, Y') }}">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <select class="form-control select2" name="shop_id" id="shop_id">
                                            ...
                                            <option value="{{ $shop->id }}" @if($damage_paid->shop_id == $shop->id) selected @endif>{{ $shop->shop_name }} | {{ $shop->owner_name }} | {{ $shop->whatsapp_number }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <div>
                                            <input data-parsley-type="text" type="number" value="{{ $damage_paid->paid_value }}" class="form-control" required placeholder="Enter Paid Value" name="paid_value" step="0.01">
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        <label class="form-label">Remarks</label>
                                        <div>
                                            <textarea class="form-control" placeholder="Enter Remarks" name="remarks">{{ $damage_paid->remarks }}</textarea>
                                        </div>
                                    </div>
