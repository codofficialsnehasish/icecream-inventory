...
<!-- end header -->
                                    ...
                                    <div class="tab-pane active p-3" id="variations" role="tabpanel">
                                        ...
                                        <table class="table table-striped  dt-responsive nowrap dataTable no-footer dtr-inline">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="width: 20%;">{{ $variation->variation_name }}</td>
                                                    <td style="width: 20%;">{{ $variation->price }}</td>
                                                    {{-- <td style="width: 35%;">
                                                    ...
                                                    <td>{{ format_datetime($variation->created_at) }}</td>
                                                    <td>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <div>
                                <input type="text" id="input_variation_label" class="form-control form-input input-variation-label" name="label_name" placeholder="Enter Option Name" maxlength="255" required="" data-parsley-type="text">
                            </div>
                        </div>
                        ...
                        <div class="mb-3" id="new_price" style="display:none;">
                            <label class="form-label">Price</label>
                            <div>
                                <input type="number" step="0.01" id="input_variation_label" class="form-control form-input input-variation-label" name="new_price" placeholder="Enter New Price" maxlength="255" data-parsley-type="text">
                            </div>
                        </div>
                        <div class="mb-3">
    ...
    @section('script')
        <script>
            ...
            $('input[name="use_different_price"]').on('change', function(){
                if ($(this).val() == '1') {
                    $('#new_price').show();
                    $('#input_variation_label').attr('required', true); // Add required attribute
                } else {
                    $('#new_price').hide();
                    $('#input_variation_label').removeAttr('required'); // Remove required attribute
                }
            });
        </script>
    @endsection
