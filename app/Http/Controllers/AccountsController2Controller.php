...
class AccountsController2Controller extends Controller
{
    ...
    {
        $data['title'] = 'Accounts 2';
        $data['accounts'] = AccountsController2::all();
    ...
    public function show(AccountsController2 $accounts)
    {
        //
    }
    ...
    {
        $data['title'] = 'Accounts 2';
        $data['account'] = AccountsController2::find($id);
    ...
    public function update(Request $request, string $id)
    {
        ...
        $acc = AccountsController2::find($id);
        $acc->date = format_date_for_db($request->bill_date);
        $acc->bill_type = $request->bill_type;
        $acc->bill_no = $request->bill_number;
        $acc->bill_amount = $request->total_bill_amount;
