...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form class="custom-validatio" action="{{ route('area.update', $area->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <input data-parsley-type="text" type="text" class="form-control"
                                                    required placeholder="Enter Area Name" value="{{$area->name}}"
                                                    name="name" id="name">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <input data-parsley-type="number" type="text" class="form-control"
                                                     required placeholder="Enter Pincode" value="{{ $area->pincode }}"
                                ...
                                <div class="row ">
                                    <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" name="state" value="{{ $area->state }}"
                                    ...
                                    <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" name="district" value="{{ $area->district }}"
                                ...
                                <div class="row mt-2">
                                    <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" name="station" value="{{ $area->police_station }}"
                                    ...
                                    <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" name="landmark" value="{{ $area->landmark }}"
